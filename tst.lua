...
local gameData = {
    ...
    {name = "Lumber Tycoon 2", placeID = 13822889, loadstringURL = "https://pastebin.com/raw/pCfuMCEr"},
    {name = "Collect All Pets", placeID = 8884433153, loadstringURL = "https://pastebin.com/raw/PJqWzz9F"},
}
...
SettingSection:NewButton("Rejoin", "rejoin server", function()
